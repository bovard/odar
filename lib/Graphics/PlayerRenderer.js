...
PlayerRenderer.prototype.render = function(renderGL, playerState, mapRenderer, currAnimationFrame, isPlayerTurn){
	...
	renderGL.drawPlayer(GraphicsConstants.FX_PLAYER_FONT_CHARACTER, 
			this.currPlayerPos, 
			GraphicsConstants.FX_PLAYER_FONT_STYLE, 
			GraphicsConstants.FX_PLAYER_FONT_COLOR);
	...
	// 		default:
	// 			renderGL.drawPlayer(
	// 				GraphicsConstants.FX_PLAYER_FONT_CHARACTER, 
	// 				this.currPlayerPos, 
	// 				GraphicsConstants.FX_PLAYER_FONT_STYLE, 
	// 				GraphicsConstants.FX_PLAYER_FONT_COLOR);
	// 	}
